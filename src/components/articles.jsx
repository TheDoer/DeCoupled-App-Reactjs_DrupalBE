...
class Articles extends Component {
  ...
  fetchArticle(nid) {
    ...
    var self = this;
    this.serverRequest = axios.get('http://marvel.test/node/' + id + '?_format=json')
  ...
  fetchArticleTitles() {
    var self = this;
    this.serverRequest = axios.get('http://marvel.test/api/v1/articles/list')
    .then(function(result){
      self.setState({
        ...
        <div className="col-md-8">
          <div className="card text-center">
            ...
            <div className="card-footer text-muted text-left">
              <em><small>Umsebenzi ka Adonis</small></em>
            </div>
          </div>
        </div>
      </div>
